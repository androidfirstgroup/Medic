...
public class HospitalActivity extends Activity  implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hospitallayout);
	...
	public void onClick(View v) {
		...
		case R.id.btMainProfile:
			...
			mainprofile.putExtra("form", Constants.FORM_BLUE);
		...
		case R.id.btSecondProfile:
			...
			profileListActivity.putExtra("form", Constants.FORM_BLUE);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch(requestCode) {
	    	case (Constants.REQUEST_ACTIVITY_CLOSE_STATE) : {
	    		if ( resultCode != Constants.GO_TO_FORM_BLUE && resultCode != Constants.NORMAL_CLOSE) {
					Intent resultIntent = new Intent();
